...
tk.Label(root, text="TRần Huy Vinh").grid(row=1, column=1, sticky="w")

tk.Label(root, text="Ngày sinh:").grid(row=2, column=0, sticky="w", padx=10, pady=5)
tk.Label(root, text="29/06/2006").grid(row=2, column=1, sticky="w")

tk.Label(root, text="MSSV:").grid(row=3, column=0, sticky="w", padx=10, pady=5)
tk.Label(root, text="245752021610007").grid(row=3, column=1, sticky="w")
